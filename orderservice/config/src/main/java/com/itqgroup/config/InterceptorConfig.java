...
public class InterceptorConfig implements HandlerInterceptor {
    ...
    private static final String MDC_UUID_KEY = "requestId";//inject from application yaml
    private static final String REQUEST_HEADER = "X-Request-ID";//inject from application yaml
    ...
    public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object handler, Exception ex) throws Exception {
        ...
        log.info("After completion: UUID={}, URI={}, Duration={} ms", MDC.get(MDC_UUID_KEY),
